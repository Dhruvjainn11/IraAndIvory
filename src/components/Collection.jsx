...
const categories = [
  {
    ...
    items: [
      { name: 'Timeless Traditions - 1', price: '₹ 75', image: '/images/Timeless Traditions - 1.jpg' },
      { name: 'Timeless Traditions - 2', price: '₹ 90', image: '/images/Timeless Traditions - 2.jpg' },
      { name: 'Timeless Traditions - 3', price: '₹ 80', image: '/images/Timeless Traditions - 3.jpg' },
      { name: 'Timeless Traditions - 4', price: '₹ 50', image: '/images/Timeless Traditions - 4.jpg' },
  ...
  
  {
    ...
    items: [
      ...
      { name: 'Little charms - 2', price: '₹ 40', image: '/images/Little charms - 2.jpg' },
      { name: 'Little charms - 3', price: '₹ 75', image: '/images/Little charms - 3.jpg' },
      { name: 'Little charms - 4', price: '₹ 45', image: '/images/Little charms - 4.jpg' },
  ...
  },
  {
    ...
    items: [
      ...
      { name: 'The Classics - 2', price: '₹ 65', image: '/images/The Classics - 2.jpg' },
      { name: 'The Classics - 3', price: '₹ 100', image: '/images/The Classics - 3.jpg' },
      { name: 'The Classics - 4', price: '₹ 60', image: '/images/The Classics - 4.jpg' },
      { name: 'The Classics - 5', price: '₹ 140', image: '/images/The Classics - 5.jpg' },
      { name: 'The Classics - 6', price: '₹ 60', image: '/images/The Classics - 6.jpg' },
    ],
  },
  {
    ...
    items: [
      { name: 'Bhaiya and Bhabhi -1', price: '₹ 170', image: '/images/Bhaiya and Bhabhi -1.jpg' },
      { name: 'Bhaiya and Bhabhi - 2', price: '₹ 250', image: '/images/Bhaiya and Bhabhi - 2.jpg' },
      { name: 'Bhaiya and Bhabhi - 3', price: '₹ 200', image: '/images/Bhaiya and Bhabhi - 3.jpg' },
      { name: 'Bhaiya and Bhabhi - 4', price: '₹ 150', image: '/images/Bhaiya and Bhabhi - 4.jpg' },
      { name: 'Bhaiya and Bhabhi - 5', price: '₹ 180', image: '/images/Bhaiya and Bhabhi - 5.jpg' },
      { name: 'Bhaiya and Bhabhi - 6', price: '₹ 120', image: '/images/Bhaiya and Bhabhi - 6.jpg' },
      { name: 'Bhaiya and Bhabhi - 7', price: '₹ 250', image: '/images/Bhaiya and Bhabhi - 7.jpg' },
    ],
  },
